...
%Updated September 21,2019 by Dan Zanko
%
...
CdA = 5.446309220966517e-05 * (FTtoM^2); % CdA for total injection line, taken from CF2 data reduction [ft^2 --> m^2]
...
while true
    ...
    for t = 1:((t_burn/deltat)-1)
       ...
       mdot_ox(t) = CdA*sqrt(2*(deltaP(t))*rho_n2o_l);
...
%        deltaP(t+1) = P_RT(t+1)-P_c(t+1) - deltaP_minor(t);
       ...
       epsilon = 0.005e6; %adjust to dampen pressure oscillations
