...
CF1.AVGmdot = mean(smooth(CF1.mdotsmthd));
...
CF2.AVGmdot = mean(CF2.mdotsmthd);
...
figure, hold on
    plot(CF1.CdA.Inj(50:length(CF1.deltaP.Tot)),CF1.mdotsmthd(50:length(CF1.deltaP.Tot)))
    plot(CF2.CdA.Inj(50:length(CF2.deltaP.Tot)),CF2.mdotsmthd(50:length(CF2.deltaP.Tot)))
